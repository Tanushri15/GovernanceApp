...
def _sample_questions() -> pd.DataFrame:
    ...
    (89, "Access, Security & Privacy", "Is sensitive data formally classified?"),
    (90, "Access, Security & Privacy", "Is classification automated where possible?"),
    (91, "Access, Security & Privacy", "Are RBAC/ABAC controls implemented?"),
    (92, "Access, Security & Privacy", "Are entitlements reviewed and recertified regularly?"),
    (93, "Access, Security & Privacy", "Are access approvals traceable to owners?"),
    (94, "Access, Security & Privacy", "Are usage purposes defined for sensitive data sharing?"),
    (95, "Access, Security & Privacy", "Are privacy impact assessments triggered where required?"),
    (96, "Access, Security & Privacy", "Are encryption/security controls applied based on classification?"),
    (97, "Access, Security & Privacy", "Are audit logs maintained for access/use?"),
    (98, "Access, Security & Privacy", "Are cross-border movement/sovereignty requirements controlled?"),
    (99, "Access, Security & Privacy", "Are privacy obligations mapped to jurisdictions?"),
    (100, "Access, Security & Privacy", "Are data owners accountable for access decisions?"), 
    ]
